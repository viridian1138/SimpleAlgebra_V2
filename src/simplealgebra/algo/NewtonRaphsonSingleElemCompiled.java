 ...
 */
public abstract class NewtonRaphsonSingleElemCompiled<R extends Elem<R,?>, S extends ElemFactory<R,S>> {
	 ...
	 * The evaluation of the function for use in the Newton-Raphson method.
	 */
	protected SymbolicElem<R,S> evalNoClone;
	 ...
	 * The evaluation of the partial derivative of the function for use in the Newton-Raphson method.
	 */
	protected SymbolicElem<R,S> partialEvalNoClone;
	 ...
	 */
	public NewtonRaphsonSingleElemCompiled( final SymbolicElem<SymbolicElem<R,S>,SymbolicElemFactory<R,S>> _function , 
	...
	public R eval( HashMap<? extends Elem<?,?>,? extends Elem<?,?>> implicitSpaceInitialGuess ) throws NotInvertibleException, MultiplicativeDistributionRequiredException
	{
		...
		lastValue = evalNoClone.eval( implicitSpace );
	...
	protected R evalIndicatesImprovement(  ) throws NotInvertibleException, MultiplicativeDistributionRequiredException
	{
		try
		{
			R ev = evalNoClone.eval( implicitSpace );
	 ...
	 */
	protected NewtonRaphsonSingleElemCompiled( NewtonRaphsonSingleElemCompiled<R,S> in , final BigInteger threadIndex )
	{
		...
		evalClone = in.evalClone.cloneThread( threadIndex );
	 ...
	 * @param threadIndex The index of the thread for which to clone.
	 */
	protected NewtonRaphsonSingleElemCompiled( NewtonRaphsonSingleElemCompiled<R,S> in , 
			...
			CloneThreadCache<?,?> cacheImplicit , final BigInteger threadIndex )
	{
		...
		evalClone = in.evalClone.cloneThreadCached( threadIndex , cacheA );
	 ...
	 */
	public abstract NewtonRaphsonSingleElemCompiled<R,S> cloneThread( final BigInteger threadIndex );
	 ...
	 * @return The thread-cloned object, or the same object if immutable.
	 */
	public abstract NewtonRaphsonSingleElemCompiled<R,S> cloneThreadCached( 
			final CloneThreadCache<SymbolicElem<SymbolicElem<R,S>,SymbolicElemFactory<R,S>>,SymbolicElemFactory<SymbolicElem<R,S>,SymbolicElemFactory<R,S>>> cache , 
	...
	{
		return( partialEvalNoClone.eval( implicitSpace ) );
	}
