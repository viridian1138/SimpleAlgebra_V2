...
public class NewtonRaphsonMultiElemNoBacktrackCacheFinal<U extends NumDimensions, R extends Elem<R,?>, S extends ElemFactory<R,S>>
	 ...
	 */
	protected NewtonRaphsonMultiElemNoBacktrackCacheFinal( NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S> in , final BigInteger threadIndex )
	{
	...
	@Override
	public NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S> cloneThread( BigInteger threadIndex )
	{
		return( new NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S>( this , threadIndex ) );
	}
