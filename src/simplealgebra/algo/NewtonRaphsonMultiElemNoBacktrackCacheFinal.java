 ...
 */
public class NewtonRaphsonMultiElemNoBacktrackCacheFinal<U extends NumDimensions, R extends Elem<R,?>, S extends ElemFactory<R,S>>
	 ...
	 */
	public NewtonRaphsonMultiElemNoBacktrackCacheFinal( 
	 ...
	 */
	protected NewtonRaphsonMultiElemNoBacktrackCacheFinal( NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S> in , 
	...
	@Override
	public NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S> cloneThread( final DescentAlgorithmMultiElemInputParamCallbacks<U,R,S> _param , BigInteger threadIndex )
	{
		return( new NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S>( this , _param , threadIndex ) );
	}
	
	
	@Override
	public NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S> cloneThreadCached(  
			final DescentAlgorithmMultiElemInputParamCallbacks<U,R,S> _param ,
			final CloneThreadCache<GeometricAlgebraMultivectorElem<U, GeometricAlgebraOrd<U>, SymbolicElem<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>, SymbolicElemFactory<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>>,GeometricAlgebraMultivectorElemFactory<U, GeometricAlgebraOrd<U>, SymbolicElem<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>, SymbolicElemFactory<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>>> cache , 
			CloneThreadCache<?,?> cacheImplicit ,
			final BigInteger threadIndex )
	{
		return( new NewtonRaphsonMultiElemNoBacktrackCacheFinal<U,R,S>( this , _param , cache , cacheImplicit , threadIndex ) );
	}
