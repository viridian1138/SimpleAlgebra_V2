 ...
 */
public class NewtonRaphsonMultiElemNoBacktrack<U extends NumDimensions, R extends Elem<R,?>, S extends ElemFactory<R,S>>
	 ...
	 */
	protected NewtonRaphsonMultiElemNoBacktrack( NewtonRaphsonMultiElemNoBacktrack<U,R,S> in , 
	...
	@Override
	public NewtonRaphsonMultiElemNoBacktrack<U,R,S> cloneThread( final DescentAlgorithmMultiElemInputParamCallbacks<U,R,S> _param , BigInteger threadIndex )
	{
		return( new NewtonRaphsonMultiElemNoBacktrack<U,R,S>( this , _param , threadIndex ) );
	}
	
	
	
	@Override
	public NewtonRaphsonMultiElemNoBacktrack<U,R,S> cloneThreadCached(  
			final DescentAlgorithmMultiElemInputParamCallbacks<U,R,S> _param ,
			final CloneThreadCache<GeometricAlgebraMultivectorElem<U, GeometricAlgebraOrd<U>, SymbolicElem<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>, SymbolicElemFactory<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>>,GeometricAlgebraMultivectorElemFactory<U, GeometricAlgebraOrd<U>, SymbolicElem<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>, SymbolicElemFactory<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>>> cache , 
			CloneThreadCache<?,?> cacheImplicit ,
			final BigInteger threadIndex )
	{
		return( new NewtonRaphsonMultiElemNoBacktrack<U,R,S>( this , _param , cache , cacheImplicit , threadIndex ) );
	}
