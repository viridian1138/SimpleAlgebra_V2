 ...
 */
public class NewtonRaphsonMultiElemSimpleBacktrackCacheFinal<U extends NumDimensions, R extends Elem<R,?>, S extends ElemFactory<R,S>>
	 ...
	 */
	public NewtonRaphsonMultiElemSimpleBacktrackCacheFinal( 
	 ...
	 */
	protected NewtonRaphsonMultiElemSimpleBacktrackCacheFinal( NewtonRaphsonMultiElemSimpleBacktrackCacheFinal<U,R,S> in , 
	...
	@Override
	public NewtonRaphsonMultiElemSimpleBacktrackCacheFinal<U,R,S> cloneThread( final DescentAlgorithmMultiElemInputParamCallbacks<U,R,S> _param , BigInteger threadIndex )
	{
		return( new NewtonRaphsonMultiElemSimpleBacktrackCacheFinal<U,R,S>( this , _param , threadIndex ) );
	}
	
	
	@Override
	public NewtonRaphsonMultiElemSimpleBacktrackCacheFinal<U,R,S> cloneThreadCached(  
			final DescentAlgorithmMultiElemInputParamCallbacks<U,R,S> _param ,
			final CloneThreadCache<GeometricAlgebraMultivectorElem<U, GeometricAlgebraOrd<U>, SymbolicElem<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>, SymbolicElemFactory<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>>,GeometricAlgebraMultivectorElemFactory<U, GeometricAlgebraOrd<U>, SymbolicElem<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>, SymbolicElemFactory<SymbolicElem<R, S>, SymbolicElemFactory<R, S>>>> cache , 
			CloneThreadCache<?,?> cacheImplicit ,
			final BigInteger threadIndex )
