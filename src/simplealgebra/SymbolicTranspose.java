	...
	SymbolicElem<SquareMatrixElem<U,R,S>,SquareMatrixElemFactory<U,R,S>> 
{
	...
	/**
	 * Constructs the transpose for use in a Drools ( <A href="http://drools.org">http://drools.org</A> ) session.
	 * 
	...
	public SquareMatrixElem<U, R, S> evalCached(
		...
		final SquareMatrixElem<U, R, S> ret = elem.evalCached( implicitSpace , cache ).handleOptionalOp( SquareMatrixElem.SquareMatrixCmd.TRANSPOSE , args);
		cache.put( key , ret );
		return( ret );
	}
