...
/**
 * Facade for Tdg_TransformMatrixGen_Facade that simplifies the generation of transformation matrices for 2D and 3D
 * 
 * @author tgreen
 *
 ...
 */
public class Tdg_TransformMatrixGen_Facade<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>>
{

	/**
	 * The transformation matrix generator
	 */
	protected Tdg_TransformMatrixGen<U,A,R,S> gen;
	 ...
	 */
	public Tdg_TransformMatrixGen_Facade( GeometricAlgebraMultivectorElemFactory<U,A,R,S> _gaFactory , SquareMatrixElemFactory<U,R,S> _matrixFactory )
	{
		gen = new Tdg_TransformMatrixGen<U,A,R,S>( _gaFactory , _matrixFactory );
	}
	...
	public SquareMatrixElem<U,R,S> identityMatrix2D() throws DimensionMismatchException
	{
		...
		if( dims.compareTo( BigInteger.valueOf( 2 ) ) != 0 )
		{
