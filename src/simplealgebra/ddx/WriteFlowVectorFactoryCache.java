...
/**
 * Cache for writing FlowVectorFactory descs.
 * 
 * @author thorngreen
 *
 ...
 */
public class WriteFlowVectorFactoryCache<R extends Elem<R,?>, S extends ElemFactory<R,S>, K extends Elem<?,?>> extends AbstractCache<FlowVectorFactory<R,S,K>,FlowVectorFactory<R,S,K>,String,String>
{
	 ...
	 */
	public WriteFlowVectorFactoryCache( WriteElemCache.IntVal in )
	{
		super();
		cacheVal = in;
	}
