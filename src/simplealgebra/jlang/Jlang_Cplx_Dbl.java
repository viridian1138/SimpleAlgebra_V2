...
/**
 * Base class for Jlang conversion of ComplexElem<DoubleElem,DoubleElemFactory> expressions.
 * 
 * @author tgreen
 *
 */
public abstract class Jlang_Cplx_Dbl extends SymbolicElem<ComplexElem<DoubleElem,DoubleElemFactory>,ComplexElemFactory<DoubleElem,DoubleElemFactory>> {

	/**
	 * Constructor.
	 * @param _fac Input factory.
	 */
	public Jlang_Cplx_Dbl(ComplexElemFactory<DoubleElem, DoubleElemFactory> _fac) {
		super(_fac);
	}

	@Override
	public abstract ComplexElem<DoubleElem, DoubleElemFactory> eval(
