...
/**
 * Constants used to configure jlang compilation for a particular machine.
 * 
 * @author tgreen
 *
 */
public class JlangConstants {
	 ...
	 */
	public static final String JLANG_JAVAC_COMMAND = "javac -cp ";
