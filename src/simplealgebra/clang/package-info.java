...
/**
 * Classes for converting some symbolic expressions to Clang (C Language) native code
 * for execution-time performance optimization.
 * <p>
 * Native conversion can produce benefits (other than just eliminating the VM as an
 * impediment) by eliminating object creation and eliminating Elem-to-Elem
 ...
 * creation can be eliminated by converting DoubleElem to a primitive Clang type.
 * <p>
 * Rules:
 * <p>
