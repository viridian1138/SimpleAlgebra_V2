 ...
 *
 */
public class ClangCompile<R extends Elem<R,?>, S extends ElemFactory<R,S>> {
	 ...
	 */
	public SymbolicElem<R,S> attemptClangCompile( SymbolicElem<R,S> in )
	{
		...
		try
		{
			...
			if( fac instanceof DoubleElemFactory )
			{
				...
				SymbolicElem<DoubleElem,DoubleElemFactory> dout = Clang.clang_Dbl( ds );
