...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicZero instances.
 * 
 ...
 */
public class SymbolicZeroType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicZeroType() {
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicZero<R,S> oid = (SymbolicZero<R,S>)( instance );
	...
	{
		SymbolicZeroType<?,?> type = new SymbolicZeroType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicZero.class );
	}
