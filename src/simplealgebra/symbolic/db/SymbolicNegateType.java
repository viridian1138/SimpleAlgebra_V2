...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicNegate instances.
 * 
 ...
 */
public class SymbolicNegateType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicNegateType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicNegate<R,S>( elemA , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicNegate<R,S> oid = (SymbolicNegate<R,S>)( instance );
	...
	{
		SymbolicNegateType<?,?> type = new SymbolicNegateType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicNegate.class );
	}
