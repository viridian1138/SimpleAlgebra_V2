...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicRandom instances.
 * 
 ...
 */
public class SymbolicRandomType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicRandomType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		PrimitiveRandom ival = graph.get( layout[ 1 ] );
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicRandom<R,S>( elemA , fac , ival ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicRandom<R,S> oid = (SymbolicRandom<R,S>)( instance );
	...
	{
		SymbolicRandomType<?,?> type = new SymbolicRandomType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicRandom.class );
	}
