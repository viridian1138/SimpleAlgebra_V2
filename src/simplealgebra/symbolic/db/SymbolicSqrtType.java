...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicSqrt instances.
 * 
 ...
 */
public class SymbolicSqrtType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicSqrtType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicSqrt<R,S>( elemA , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicSqrt<R,S> oid = (SymbolicSqrt<R,S>)( instance );
	...
	{
		SymbolicSqrtType<?,?> type = new SymbolicSqrtType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicSqrt.class );
	}
