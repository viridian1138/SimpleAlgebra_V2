 ...
 */
public class SymbolicInvertLeftType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicInvertLeftType() {
	}
	...
	{
		SymbolicInvertLeftType<?,?> type = new SymbolicInvertLeftType();
