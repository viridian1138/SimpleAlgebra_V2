...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicPlaceholder instances.
 * 
 ...
 */
public class SymbolicPlaceholderType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicPlaceholderType() {
	}
	...
	{
		SymbolicPlaceholderType<?,?> type = new SymbolicPlaceholderType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicPlaceholder.class );
	}
