...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicInvertLeft instances.
 * 
 ...
 */
public class SymbolicInvertRightType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicInvertRightType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicInvertLeft<R,S>( elemA , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicInvertLeft<R,S> oid = (SymbolicInvertLeft<R,S>)( instance );
	...
	{
		SymbolicInvertRightType<?,?> type = new SymbolicInvertRightType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicInvertLeft.class );
	}
