...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicIdentity instances.
 * 
 ...
 */
public class SymbolicIdentityType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicIdentityType() {
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicIdentity<R,S> oid = (SymbolicIdentity<R,S>)( instance );
	...
	{
		SymbolicIdentityType<?,?> type = new SymbolicIdentityType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicIdentity.class );
	}
