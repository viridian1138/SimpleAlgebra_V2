...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicReverseRight instances.
 * 
 ...
 */
public class SymbolicReverseRightType<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicReverseRightType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicReverseRight<U,A,R,S>( elemA , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicReverseRight<U,A,R,S> oid = (SymbolicReverseRight<U,A,R,S>)( instance );
	...
	{
		SymbolicReverseRightType<?,?,?,?> type = new SymbolicReverseRightType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicReverseRight.class );
	}
