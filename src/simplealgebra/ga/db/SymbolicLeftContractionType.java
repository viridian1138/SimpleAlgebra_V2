...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicLeftContraction instances.
 * 
 ...
 */
public class SymbolicLeftContractionType<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicLeftContractionType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicLeftContraction<U,A,R,S>( elemA , elemB , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicLeftContraction<U,A,R,S> oid = (SymbolicLeftContraction<U,A,R,S>)( instance );
	...
	{
		SymbolicLeftContractionType<?,?,?,?> type = new SymbolicLeftContractionType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicLeftContraction.class );
	}
