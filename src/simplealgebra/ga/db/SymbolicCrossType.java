...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicCross instances.
 * 
 ...
 */
public class SymbolicCrossType<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicCrossType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicCross<U,A,R,S>( elemA , elemB , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicCross<U,A,R,S> oid = (SymbolicCross<U,A,R,S>)( instance );
	...
	{
		SymbolicCrossType<?,?,?,?> type = new SymbolicCrossType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicCross.class );
	}
