...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicScalar instances.
 * 
 ...
 */
public class SymbolicScalarType<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicScalarType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicScalar<U,A,R,S>( elemA , elemB , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicScalar<U,A,R,S> oid = (SymbolicScalar<U,A,R,S>)( instance );
	...
	{
		SymbolicScalarType<?,?,?,?> type = new SymbolicScalarType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicScalar.class );
	}
