...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicWedge instances.
 * 
 ...
 */
public class SymbolicWedgeType<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicWedgeType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicWedge<U,A,R,S>( elemA , elemB , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicWedge<U,A,R,S> oid = (SymbolicWedge<U,A,R,S>)( instance );
	...
	{
		SymbolicWedgeType<?,?,?,?> type = new SymbolicWedgeType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicWedge.class );
	}
