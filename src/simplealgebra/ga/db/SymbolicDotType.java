...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing SymbolicDot instances.
 * 
 ...
 */
public class SymbolicDotType<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicDotType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicDot<U,A,R,S>( elemA , elemB , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicDot<U,A,R,S> oid = (SymbolicDot<U,A,R,S>)( instance );
	...
	{
		SymbolicDotType<?,?,?,?> type = new SymbolicDotType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicDot.class );
	}
