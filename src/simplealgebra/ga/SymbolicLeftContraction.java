...
/**
 * Symbolic elem for the Geometric Algebra left contraction product <math display="inline">
 * <mrow>
 *   <mi>A</mi>
 *   <mo>&rfloor;</mo>
 *   <mi>B</mi>
 ...
 */
public class SymbolicLeftContraction<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends 
	SymbolicElem<GeometricAlgebraMultivectorElem<U,A,R,S>,GeometricAlgebraMultivectorElemFactory<U,A,R,S>> 
{

	/**
	 * Constructs the left contraction product.
	 * 
	 ...
	 */
	public SymbolicLeftContraction( 
	...
	public GeometricAlgebraMultivectorElem<U,A, R, S> eval( HashMap<? extends Elem<?,?>,? extends Elem<?,?>> implicitSpace ) throws NotInvertibleException,
		...
		return( elemA.eval( implicitSpace ).handleOptionalOp( GeometricAlgebraMultivectorElem.GeometricAlgebraMultivectorCmd.LEFT_CONTRACTION , args ) );
	}
	...
	public GeometricAlgebraMultivectorElem<U, A, R, S> evalCached(
		...
		final GeometricAlgebraMultivectorElem<U, A, R, S> ret = 
				elemA.evalCached( implicitSpace , cache ).handleOptionalOp( GeometricAlgebraMultivectorElem.GeometricAlgebraMultivectorCmd.LEFT_CONTRACTION , args );
		cache.put(key, ret);
		return( ret );
	}
	...
	@Override
	public SymbolicLeftContraction<U,A,R,S> cloneThread( final BigInteger threadIndex )
	{
		...
		{
			return( new SymbolicLeftContraction<U,A,R,S>( elemAs , elemBs , facs ) );
		}
		return( this );
	}
			...
			CloneThreadCache<SymbolicElem<GeometricAlgebraMultivectorElem<U, A, R, S>, GeometricAlgebraMultivectorElemFactory<U, A, R, S>>, SymbolicElemFactory<GeometricAlgebraMultivectorElem<U, A, R, S>, GeometricAlgebraMultivectorElemFactory<U, A, R, S>>> cache) 
	{
		...
		{
			final SymbolicLeftContraction<U,A,R,S> rtmp = new SymbolicLeftContraction<U,A,R,S>( elemA2 , elemB2 , facs );
			cache.put(this, rtmp);
			return( rtmp );
		}
		cache.put(this, this);
	...
	public String writeDesc( WriteElemCache<SymbolicElem<GeometricAlgebraMultivectorElem<U,A,R,S>,GeometricAlgebraMultivectorElemFactory<U,A,R,S>>,SymbolicElemFactory<GeometricAlgebraMultivectorElem<U,A,R,S>,GeometricAlgebraMultivectorElemFactory<U,A,R,S>>> cache , PrintStream ps )
	{
		...
		if( st == null )
		{
			...
			cache.put(this, st);
			ps.print( SymbolicLeftContraction.class.getSimpleName() );
			ps.print( "<" );
	...
	/**
	 * Returns the left argument of the left contraction product.
	 * 
	 * @return The left argument of the left contraction product.
	 */
	...
	/**
	 * Returns the right argument of the left contraction product.
	 * 
	 * @return The right argument of the left contraction product.
	 */
