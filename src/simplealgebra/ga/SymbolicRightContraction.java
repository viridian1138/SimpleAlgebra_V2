 ...
 */
public class SymbolicRightContraction<U extends NumDimensions, A extends Ord<U>, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends 
	SymbolicElem<GeometricAlgebraMultivectorElem<U,A,R,S>,GeometricAlgebraMultivectorElemFactory<U,A,R,S>> 
{

	/**
	 * Constructs the right contraction product.
	 * 
	 ...
	 */
	public SymbolicRightContraction( 
	...
	public GeometricAlgebraMultivectorElem<U,A, R, S> eval( HashMap<? extends Elem<?,?>,? extends Elem<?,?>> implicitSpace ) throws NotInvertibleException,
		...
		return( elemA.eval( implicitSpace ).handleOptionalOp( GeometricAlgebraMultivectorElem.GeometricAlgebraMultivectorCmd.RIGHT_CONTRACTION , args ) );
	}
	...
	public GeometricAlgebraMultivectorElem<U, A, R, S> evalCached(
		...
		final GeometricAlgebraMultivectorElem<U, A, R, S> ret = 
				elemA.evalCached( implicitSpace , cache ).handleOptionalOp( GeometricAlgebraMultivectorElem.GeometricAlgebraMultivectorCmd.RIGHT_CONTRACTION , args );
		cache.put(key, ret);
		return( ret );
	}
	...
	@Override
	public SymbolicRightContraction<U,A,R,S> cloneThread( final BigInteger threadIndex )
	{
		...
		{
			return( new SymbolicRightContraction<U,A,R,S>( elemAs , elemBs , facs ) );
		}
		return( this );
	}
			...
			CloneThreadCache<SymbolicElem<GeometricAlgebraMultivectorElem<U, A, R, S>, GeometricAlgebraMultivectorElemFactory<U, A, R, S>>, SymbolicElemFactory<GeometricAlgebraMultivectorElem<U, A, R, S>, GeometricAlgebraMultivectorElemFactory<U, A, R, S>>> cache) 
	{
		...
		{
			final SymbolicRightContraction<U,A,R,S> rtmp = new SymbolicRightContraction<U,A,R,S>( elemA2 , elemB2 , facs );
			cache.put(this, rtmp);
			return( rtmp );
		}
		cache.put(this, this);
	...
	/**
	 * Returns the right argument of the right contraction product.
	 * 
	 * @return The right argument of the right contraction product.
	 */
