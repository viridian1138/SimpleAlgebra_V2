...
/**
 * Cache for writing NumDimensions descs.
 * 
 * @author thorngreen
 */
public class WriteNumDimensionsCache extends AbstractCache<NumDimensions,NumDimensions,String,String>
{
	 ...
	 */
	public WriteNumDimensionsCache( WriteElemCache.IntVal in )
	{
		super();
		cacheVal = in;
	}
