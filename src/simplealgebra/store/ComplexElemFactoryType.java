...
/**
 * HyperGraph ( <A href="http://hypergraphdb.org">http://hypergraphdb.org</A> ) type for storing ComplexElemFactory instances.
 * 
 ...
 *
 */
public class ComplexElemFactoryType<R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public ComplexElemFactoryType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		return( new ComplexElemFactory<R,S>( fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		ComplexElemFactory<R,S> oid = (ComplexElemFactory<R,S>)( instance );
