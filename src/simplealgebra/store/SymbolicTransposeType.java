 ...
 */
public class SymbolicTransposeType<U extends NumDimensions, R extends Elem<R,?>, S extends ElemFactory<R,S>> extends HGAtomTypeBase {

	
	/**
	 * Constructs the type instance.
	 */
	public SymbolicTransposeType() {
	}
	...
	public Object make(HGPersistentHandle handle, LazyRef<HGHandle[]> targetSet,
		...
		if( fac == null )
			throw( new RuntimeException( "Failed" ) );
		return( new SymbolicTranspose<U,R,S>( elemA , fac ) );
	}
	...
	public HGPersistentHandle store(Object instance) {
		SymbolicTranspose<U,R,S> oid = (SymbolicTranspose<U,R,S>)( instance );
	...
	{
		SymbolicTransposeType<?,?,?> type = new SymbolicTransposeType();
		HGPersistentHandle typeHandle = graph.getHandleFactory().makeHandle();
		graph.getTypeSystem().addPredefinedType( typeHandle , type , SymbolicTranspose.class );
	}
