...
/**
 * Cache for writing precision descs.
 * 
 * @author thorngreen
 *
 * @param <T> The elem type.
 */
public class WritePrecisionCache<T extends Precision<T>> extends AbstractCache<T,T,String,String>
{
	 ...
	 */
	public WritePrecisionCache( WriteElemCache.IntVal in )
	{
		super();
		cacheVal = in;
	}
