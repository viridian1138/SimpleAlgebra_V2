	...
	SymbolicElem<ComplexElem<R,S>,ComplexElemFactory<R,S>> 
{
	 ...
	 */
	public SymbolicConjugateRight( SymbolicElem<ComplexElem<R,S>,ComplexElemFactory<R,S>> _elem , ComplexElemFactory<R, S> _fac, DroolsSession ds ) 
	{
		this( _elem , _fac );
		ds.insert( this );
	}
	...
	public String writeDesc( WriteElemCache<SymbolicElem<ComplexElem<R,S>,ComplexElemFactory<R,S>>,SymbolicElemFactory<ComplexElem<R,S>,ComplexElemFactory<R,S>>> cache , PrintStream ps )
	{
		...
		if( st == null )
		{
			...
			cache.put(this, st);
			ps.print( SymbolicConjugateRight.class.getSimpleName() );
			ps.print( "<" );
