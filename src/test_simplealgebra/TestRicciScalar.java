...
/**
 * Tests the ability to generate Ricci scalars.  Uses JUnit ( <A href="http://junit.org">http://junit.org</A> ).
 * 
...
public class TestRicciScalar extends TestCase {
	...
	public void testRicciScalar() throws NotInvertibleException, MultiplicativeDistributionRequiredException
	{
		...
		final RicciScalarFactory<String, TestDimensionFour, DoubleElem, DoubleElemFactory, Ordinate> cofac =
			new RicciScalarFactory<String, TestDimensionFour, DoubleElem, DoubleElemFactory, Ordinate>(se2s, tmt, new TestTemporaryIndexFactory(), ofacI);
