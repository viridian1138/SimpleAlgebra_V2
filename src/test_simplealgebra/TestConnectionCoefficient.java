...
public class TestConnectionCoefficient extends TestCase {
	...
	public void testConnectionCoefficient() throws NotInvertibleException, MultiplicativeDistributionRequiredException
	{
		...
		final ConnectionCoefficientFactory<String, TestDimensionFour, DoubleElem, DoubleElemFactory, AElem> ofac =
				new ConnectionCoefficientFactory<String, TestDimensionFour, DoubleElem, DoubleElemFactory, AElem>(
