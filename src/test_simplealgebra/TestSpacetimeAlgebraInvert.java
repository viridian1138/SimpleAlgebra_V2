...
public class TestSpacetimeAlgebraInvert extends TestCase {
	 ...
	 */
	private void validateIsIdentity( GeometricAlgebraMultivectorElem<TestDimensionFive,SpacetimeAlgebraOrd<TestDimensionFive>,DoubleElem,DoubleElemFactory> shouldBeIdent )
	{
		final int max = 1 << 5;
