...
/**
 * Tests the dot product between a vector and a scalar.  Uses JUnit ( <A href="http://junit.org">http://junit.org</A> ).
 * 
 ...
 *
 */
public class TestScalarDot extends TestCase {
	
	
	
	/**
	 * Tests the dot product between a vector and a scalar.
	 * 
	 * @throws NotInvertibleException
	 */
	public void testScalarDotA( ) throws Throwable
	{
	 ...
	 * @throws NotInvertibleException
	 */
	public void testScalarDotB( ) throws Throwable
	{
		Random rand = new Random( 5432 );
		...
		final GeometricAlgebraMultivectorElem<TestDimensionThree,GeometricAlgebraOrd<TestDimensionThree>,DoubleElem,DoubleElemFactory> 
			prod = mvB.handleOptionalOp( GeometricAlgebraMultivectorElem.GeometricAlgebraMultivectorCmd.DOT , args );
	 ...
	 * @throws NotInvertibleException
	 */
	public void testScalarDotHestenesA( ) throws Throwable
	{
		Random rand = new Random( 5432 );
	 ...
	 * @throws NotInvertibleException
	 */
	public void testScalarDotHestenesB( ) throws Throwable
	{
		Random rand = new Random( 5432 );
		...
		final GeometricAlgebraMultivectorElem<TestDimensionThree,GeometricAlgebraOrd<TestDimensionThree>,DoubleElem,DoubleElemFactory> 
			prod = mvB.handleOptionalOp( GeometricAlgebraMultivectorElem.GeometricAlgebraMultivectorCmd.DOT_HESTENES , args );
