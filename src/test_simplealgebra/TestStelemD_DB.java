...
public class TestStelemD_DB extends TestCase {
	 ...
	 * @param zcnt The Z-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftZup( final int tcnt , final int xcnt , final int ycnt , final int zcnt )
	{
	 ...
	 * @param zcnt The Z-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftZdown( final int tcnt , final int xcnt , final int ycnt , final int zcnt )
	{
		for( int ta = 0 ; ta < 2 * NSTPT + 1 ; ta++ )
		{
			for( int xa = 0 ; xa < 2 * NSTPX + 1 ; xa++ )
	 ...
	 * @param zcnt The Z-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftYup( final int tcnt , final int xcnt , final int ycnt , final int zcnt )
	{
		for( int ta = 0 ; ta < 2 * NSTPT + 1 ; ta++ )
		{
			for( int xa = 0 ; xa < 2 * NSTPX + 1 ; xa++ )
	 ...
	 * @param zcnt The Z-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftYdown( final int tcnt , final int xcnt , final int ycnt , final int zcnt )
	{
		for( int ta = 0 ; ta < 2 * NSTPT + 1 ; ta++ )
		{
			for( int xa = 0 ; xa < 2 * NSTPX + 1 ; xa++ )
	 ...
	 * @param zcnt The Z-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftXup( final int tcnt , final int xcnt , final int ycnt , final int zcnt )
	{
		for( int ta = 0 ; ta < 2 * NSTPT + 1 ; ta++ )
		{
	...
	protected static class StelemNewton extends NewtonRaphsonSingleElem<DoubleElem,DoubleElemFactory>
	{
		...
		{
			TestStelemD_DB.cacheIterationValue();
		}
		
		@Override
		protected void retrieveIterationValue()
		{
			TestStelemD_DB.retrieveIterationValue();
		}
