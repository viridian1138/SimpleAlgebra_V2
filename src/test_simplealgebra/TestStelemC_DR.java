 ...
 *
 */
public class TestStelemC_DR extends TestCase {
	 ...
	 */
	protected static DrFastArray3D_Dbl iterArray = null;
	 ...
	 * @param ycnt The Y-Axis index for the center in the iter array.
	 */
	protected static void fillTempArray( final int tcnt , final int xcnt , final int ycnt ) throws Throwable
	{
	 ...
	 * @param ycnt The Y-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftYup( final int tcnt , final int xcnt , final int ycnt ) throws Throwable
	{
	 ...
	 * @param ycnt The Y-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftYdown( final int tcnt , final int xcnt , final int ycnt ) throws Throwable
	{
		for( int ta = 0 ; ta < 2 * NSTPT + 1 ; ta++ )
		{
			for( int xa = 0 ; xa < 2 * NSTPX + 1 ; xa++ )
	 ...
	 * @param ycnt The Y-Axis index for the center in the iter array.
	 */
	protected static void fillTempArrayShiftXup( final int tcnt , final int xcnt , final int ycnt ) throws Throwable
	{
		for( int ta = 0 ; ta < 2 * NSTPT + 1 ; ta++ )
		{
	...
	private static class BNelem extends Nelem<DoubleElem,DoubleElemFactory,Ordinate>
	{
		...
		public DoubleElem eval(HashMap<? extends Elem<?, ?>, ? extends Elem<?, ?>> implicitSpace)
			...
			return( new DoubleElem( TestStelemC_DR.tempArray[ cols[ 0 ] ][ cols[ 1 ] ][ cols[ 2 ] ] ) );
		}
	...
	protected static class StelemNewton extends NewtonRaphsonSingleElem<DoubleElem,DoubleElemFactory>
	{
		...
		{
			TestStelemC_DR.performIterationUpdate( iterationOffset );
		}
		
		@Override
		protected void cacheIterationValue()
		{
			TestStelemC_DR.cacheIterationValue();
		}
		
		@Override
		protected void retrieveIterationValue()
		{
			TestStelemC_DR.retrieveIterationValue();
		}
			...
			throws NotInvertibleException, MultiplicativeDistributionRequiredException, Throwable
	{
		...
		{	
			...
			final double ival = TestStelemC_DR.getUpdateValue();
			...
			final double val = TestStelemC_DR.getUpdateValue();
	...
	public void testStelemSimple() throws NotInvertibleException, MultiplicativeDistributionRequiredException, Throwable
	{
		...
		iterArray = new DrFastArray3D_Dbl( dparam , databaseLocation );
