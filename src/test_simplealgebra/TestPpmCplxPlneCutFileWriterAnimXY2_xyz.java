 ...
 *
 */
public class TestPpmCplxPlneCutFileWriterAnimXY2_xyz extends TestCase {
	...
	protected static class TstPpmFileWriterAnimB extends RawFileWriter
	{
		...
		public TstPpmFileWriterAnimB( final int _tval ) throws Throwable
		{
			...
			String databaseLocationRe = "/media/tgreen/My Passport/mydbRe"; // DatabasePathForTest.FILESPACE_PATH + "mydbRe";
			
			String databaseLocationIm = "/media/tgreen/My Passport/mydbIm"; // DatabasePathForTest.FILESPACE_PATH + "mydbIm";
		...
		protected double getActValRe( int t, int x, int y, int z )throws Throwable
		{
			...
			final double xd0rep2 = iterArrayRe.get(t, x+1, y, z);
			final double xd0imp2 = iterArrayIm.get(t, x+1, y, z);
			...
			final double yd0rep2 = iterArrayRe.get(t, x, y+1, z);
			final double yd0imp2 = iterArrayIm.get(t, x, y+1, z);
			...
			final double zd0rep2 = iterArrayRe.get(t, x, y, z+1);
			final double zd0imp2 = iterArrayIm.get(t, x, y, z+1);
			
			ComplexElem<DoubleElem,DoubleElemFactory> xd0 = new ComplexElem<DoubleElem,DoubleElemFactory>( new DoubleElem( xd0re ) , new DoubleElem( xd0im ) );
			ComplexElem<DoubleElem,DoubleElemFactory> xd0p = new ComplexElem<DoubleElem,DoubleElemFactory>( new DoubleElem( xd0rep ) , new DoubleElem( xd0imp ) );
			ComplexElem<DoubleElem,DoubleElemFactory> xd0p2 = new ComplexElem<DoubleElem,DoubleElemFactory>( new DoubleElem( xd0rep2 ) , new DoubleElem( xd0imp2 ) );
			
			ComplexElem<DoubleElem,DoubleElemFactory> yd0 = new ComplexElem<DoubleElem,DoubleElemFactory>( new DoubleElem( yd0re ) , new DoubleElem( yd0im ) );
			...
			ComplexElem<DoubleElem,DoubleElemFactory> yd0p2 = new ComplexElem<DoubleElem,DoubleElemFactory>( new DoubleElem( yd0rep2 ) , new DoubleElem( yd0imp2 ) );
			
			ComplexElem<DoubleElem,DoubleElemFactory> zd0 = new ComplexElem<DoubleElem,DoubleElemFactory>( new DoubleElem( zd0re ) , new DoubleElem( zd0im ) );
			...
			ComplexElem<DoubleElem,DoubleElemFactory> zd0p2 = new ComplexElem<DoubleElem,DoubleElemFactory>( new DoubleElem( zd0rep2 ) , new DoubleElem( zd0imp2 ) );
			
			ComplexElem<DoubleElem,DoubleElemFactory> xd1u0 = xd0p.add( xd0.negate() );
			ComplexElem<DoubleElem,DoubleElemFactory> xd1u1 = xd0p2.add( xd0p.negate() );
			ComplexElem<DoubleElem,DoubleElemFactory> xd1 = xd1u1.add( xd1u0.negate() );
			
			ComplexElem<DoubleElem,DoubleElemFactory> yd1u0 = yd0p.add( yd0.negate() );
			ComplexElem<DoubleElem,DoubleElemFactory> yd1u1 = yd0p2.add( yd0p.negate() );
			ComplexElem<DoubleElem,DoubleElemFactory> yd1 = yd1u1.add( yd1u0.negate() );
			
			ComplexElem<DoubleElem,DoubleElemFactory> zd1u0 = zd0p.add( zd0.negate() );
			ComplexElem<DoubleElem,DoubleElemFactory> zd1u1 = zd0p2.add( zd0p.negate() );
			ComplexElem<DoubleElem,DoubleElemFactory> zd1 = zd1u1.add( zd1u0.negate() );
			
			ComplexElem<DoubleElem,DoubleElemFactory> d1 = ( xd1.mult( xmult ) ).add( yd1.mult( ymult ) ).add( zd1.mult( zmult ) );
			
			ComplexElem<DoubleElem,DoubleElemFactory> d2 = xd0p.handleOptionalOp( ComplexCmd.CONJUGATE_LEFT , null );
			
			ComplexElem<DoubleElem,DoubleElemFactory> d3 = II.mult( II ).mult( d1 );
