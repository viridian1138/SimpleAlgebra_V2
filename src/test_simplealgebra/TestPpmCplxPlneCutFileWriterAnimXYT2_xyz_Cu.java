...
import simplealgebra.store.CuFastArray_4D_Dbl_Cplx;
 ...
 *
 */
public class TestPpmCplxPlneCutFileWriterAnimXYT2_xyz_Cu extends TestCase {
	...
	protected static class TstPpmFileWriterAnimB extends RawFileWriter
	{
		 ...
		 */
		protected CuFastArray_4D_Dbl_Cplx iterArrayRe = null;
		
		
		/**
		 * Imaginary result array over which to get data.
		 */
		protected CuFastArray_4D_Dbl_Cplx iterArrayIm = null;
		...
		public TstPpmFileWriterAnimB( final int _tval ) throws Throwable
		{
			...
			String databaseLocationRe = DatabasePathForTest.FILESPACE_PATH + "outdir";
			
			String databaseLocationIm = DatabasePathForTest.FILESPACE_PATH + "outdir";
			...
			iterArrayRe = new CuFastArray_4D_Dbl_Cplx( dparam , databaseLocationRe , false );
			
			iterArrayIm = new CuFastArray_4D_Dbl_Cplx( dparam , databaseLocationIm , true );
