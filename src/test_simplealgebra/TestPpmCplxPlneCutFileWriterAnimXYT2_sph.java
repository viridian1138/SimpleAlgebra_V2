 ...
 * 
 * Tests generation of the projection of a semi-spherical area onto a plane.  No integration of values across the boundary.  Calculation of rough spatial derivatives.
 * 
 ...
 *
 */
public class TestPpmCplxPlneCutFileWriterAnimXYT2_sph extends TestCase {
	 ...
	 *
	 */
	protected static class TstPpmFileWriterAnimXYT2_sph extends RawFileWriter
	{
		 ...
		 * @throws Throwable
		 */
		public TstPpmFileWriterAnimXYT2_sph( final int _tval ) throws Throwable
		{
			tval = _tval;
				...
				public void run()
				{
					try
					{
						for( int cnt = core ; cnt < ( T_MAX - 1 ) ; cnt = cnt + numCores )
						{
							...
							TstPpmFileWriterAnimXYT2_sph writer = new TstPpmFileWriterAnimXYT2_sph( tval );
