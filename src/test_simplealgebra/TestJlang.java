...
import simplealgebra.jlang.Jlang;
...
/**
 * Tests the ability to convert some symbolic expressions to Jlang (Java Language) bytecode
 ...
 *
 */
public class TestJlang extends TestCase {
	...
	public void testSimplePolynomialDbl() throws Throwable
	{
		...
		final SymbolicElem<DoubleElem,DoubleElemFactory> gen = Jlang.jlang_Dbl( un );
	...
	public void testSimplePolynomialDbl_Cplx() throws Throwable
	{
		...
		final SymbolicElem<ComplexElem<DoubleElem,DoubleElemFactory>,ComplexElemFactory<DoubleElem,DoubleElemFactory>> gen = Jlang.jlang_Cplx_Dbl( un );
		for( int cnt = 0 ; cnt < 100 ; cnt++ )
		{
	...
	/**
	 * Tests the ability to convert a simple DoubleElem expression to JLang.
	 * @throws Throwable
	 */
	public void testJLangDbl() throws Throwable
	{
		final DoubleElemFactory dfac = new DoubleElemFactory();
		final SymbolicElemFactory<DoubleElem,DoubleElemFactory> sfac = new SymbolicElemFactory<DoubleElem,DoubleElemFactory>( dfac );
		final SymbolicElem<DoubleElem,DoubleElemFactory> un 
	...
	/**
	 * Tests the ability to convert a constant with exponential notation to JLang
	 * @throws Throwable
	 */
	public void testJLangExponent() throws Throwable
	{
		final DoubleElemFactory dfac = new DoubleElemFactory();
		final SymbolicElemFactory<DoubleElem,DoubleElemFactory> sfac = new SymbolicElemFactory<DoubleElem,DoubleElemFactory>( dfac );
		final SymbolicElem<DoubleElem,DoubleElemFactory> un 
	...
	/**
	 * Tests the ability to convert a simple ComplexElem expression to JLang.
	 * @throws Throwable
	 */
	public void testJLangCplx() throws Throwable
	{
		final DoubleElemFactory dfac = new DoubleElemFactory();
		final ComplexElemFactory<DoubleElem,DoubleElemFactory> cfac = new ComplexElemFactory<DoubleElem,DoubleElemFactory>( dfac );
		final SymbolicElemFactory<ComplexElem<DoubleElem,DoubleElemFactory>,ComplexElemFactory<DoubleElem,DoubleElemFactory>> sfac = 
