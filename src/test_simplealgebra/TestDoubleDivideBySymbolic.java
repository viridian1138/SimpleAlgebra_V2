 ...
 *
 */
public class TestDoubleDivideBySymbolic extends TestCase 
{

	
	/**
	 * Tests the simplification of a double divide-by of the identity.
	 * 
	 * @throws NotInvertibleException
	 */
	public void testDoubleNegateElemsA() throws NotInvertibleException
	{
		...
		SymbolicElem<SquareMatrixElem<TestDimensionFour,DoubleElem,DoubleElemFactory>,SquareMatrixElemFactory<TestDimensionFour,DoubleElem,DoubleElemFactory>>
			d3 = d2; // d2.handleOptionalOp( SymbolicOps.DISTRIBUTE_SIMPLIFY , null);
		
		Assert.assertTrue( d3 instanceof SymbolicDivideBy );
		
		SymbolicDivideBy<SquareMatrixElem<TestDimensionFour,DoubleElem,DoubleElemFactory>,SquareMatrixElemFactory<
			TestDimensionFour,DoubleElem,DoubleElemFactory>> d3a =
			(SymbolicDivideBy<SquareMatrixElem<TestDimensionFour,DoubleElem,DoubleElemFactory>,SquareMatrixElemFactory<
			TestDimensionFour,DoubleElem,DoubleElemFactory>>) d3;
		
		Assert.assertTrue( d3a.getElem() instanceof SymbolicIdentity );
		
		Assert.assertTrue( d3a.getIval().equals( BigInteger.valueOf( 23 * 49 ) ) );
	 ...
	 * @throws NotInvertibleException
	 */
	public void testDoubleNegateElemsB() throws NotInvertibleException
	{
		final TestDimensionFour td = new TestDimensionFour();
		...
		SymbolicElem<SquareMatrixElem<TestDimensionFour,DoubleElem,DoubleElemFactory>,SquareMatrixElemFactory<TestDimensionFour,DoubleElem,DoubleElemFactory>>
			d1 = new SymbolicDivideBy<SquareMatrixElem<TestDimensionFour,DoubleElem,DoubleElemFactory>,SquareMatrixElemFactory<
			TestDimensionFour,DoubleElem,DoubleElemFactory>>( d0 , se , BigInteger.valueOf( 23 ) );
		
		SymbolicElem<SquareMatrixElem<TestDimensionFour,DoubleElem,DoubleElemFactory>,SquareMatrixElemFactory<TestDimensionFour,DoubleElem,DoubleElemFactory>>
			d2 = new SymbolicDivideBy<SquareMatrixElem<TestDimensionFour,DoubleElem,DoubleElemFactory>,SquareMatrixElemFactory<
