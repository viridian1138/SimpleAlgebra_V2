 ...
 * 
 * Tests generation of the Y-Z plane at a chosen constant X.      Calculation of rough time derivatives (TestA).
 * 
 ...
 *
 */
public class TestPpmCplxPlneCutFileWriterAnim3C extends TestCase {
	 ...
	 *
	 */
	protected static class TstPpmFileWriterAnim3C extends RawFileWriter
	{
		 ...
		 * @throws Throwable
		 */
		public TstPpmFileWriterAnim3C( final int _tval ) throws Throwable
		{
			tval = _tval;
				...
				public void run()
				{
					try
					{
						for( int cnt = core ; cnt < ( T_MAX - 1 ) ; cnt = cnt + numCores )
						{
							...
							TstPpmFileWriterAnim3C writer = new TstPpmFileWriterAnim3C( tval );
