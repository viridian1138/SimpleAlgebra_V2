 ...
 *
 */
public class TestStelemD_DR_Ncore extends TestCase {
	 ...
	 */
	protected static TestStelemD_DR_Ncore.IterationThreadContext[] initIterationThreadContext()
	{
		final TestStelemD_DR_Ncore.IterationThreadContext[] ret = new TestStelemD_DR_Ncore.IterationThreadContext[ NUM_CPU_CORES ];
		for( int cnt = 0 ; cnt < NUM_CPU_CORES ; cnt++ )
		{
			ret[ cnt ] = new TestStelemD_DR_Ncore.IterationThreadContext();
		}
		return( ret );
	}
	 ...
	 */
	protected static TestStelemD_DR_Ncore.IterationThreadContext[] iterationThreadContexts = initIterationThreadContext();
	...
	private static class BNelem extends Nelem<DoubleElem,DoubleElemFactory,Ordinate>
	{
		 ...
		 */
		protected TestStelemD_DR_Ncore.IterationThreadContext threadContext;
	...
	protected static class StelemNewton extends NewtonRaphsonSingleElem<DoubleElem,DoubleElemFactory>
	{
		...
		protected StelemNewton( final StelemNewton in , final BigInteger threadIndex )
		{
			super( in , threadIndex );
			final int threadInd = threadIndex.intValue();
			threadContext = TestStelemD_DR_Ncore.iterationThreadContexts[ threadInd ];
		}
	...
	protected void initIterArray( final double d1 ) throws Throwable
	{
		...
		final TestStelemD_DR_Ncore.IterationThreadContext iterContext = iterationThreadContexts[ 0 ];
			...
			throws NotInvertibleException, MultiplicativeDistributionRequiredException, Throwable
	{
		...
		for( int ccnt = 0 ; ccnt < NUM_CPU_CORES ; ccnt++ )
		{
			...
			final TestStelemD_DR_Ncore.IterationThreadContext threadContext = iterationThreadContexts[ core ];
	...
	public void testStelemSimple() throws NotInvertibleException, MultiplicativeDistributionRequiredException, Throwable
	{
		...
		{
			TestStelemD_DR_Ncore.iterationThreadContexts[ hcnt ].iterArray = new DrFastArray4D_Dbl( dparam , databaseLocation );
		}
		...
		System.out.println( "==============================" );
		System.out.println( TestStelemD_DR_Ncore.iterationThreadContexts[ 0 ].iterArray.get( NUM_T_ITER - 1 , HALF_X , HALF_Y , HALF_Z ) );
