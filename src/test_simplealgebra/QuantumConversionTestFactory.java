...
import simplealgebra.et.RicciScalarFactory;
import simplealgebra.et.RicciTensorFactory;
...
*/
public class QuantumConversionTestFactory<Z extends Object, U extends NumDimensions, R extends Elem<R,?>, S extends ElemFactory<R,S>, K extends Elem<?,?>> {
