...
public class TestRicciTensor extends TestCase {
	...
	public void testRicciTensor() throws NotInvertibleException, MultiplicativeDistributionRequiredException
	{
		...
		final RicciTensorFactory<String, TestDimensionFour, DoubleElem, DoubleElemFactory, AElem> cofac =
			new RicciTensorFactory<String, TestDimensionFour, DoubleElem, DoubleElemFactory, AElem>(se2s, tmt, new TestTemporaryIndexFactory(), ofacI);
