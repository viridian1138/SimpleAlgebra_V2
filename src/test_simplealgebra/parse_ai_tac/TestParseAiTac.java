 ...
 *
 */
public class TestParseAiTac extends TestCase {
	 ...
	 *
	 */
	private static class ConstLiteralElem extends SymbolicElem<DoubleElem,DoubleElemFactory>
	{
		/**
		 * The index of the component.
		 */
		private DoubleElem col;
		 ...
		 */
		public ConstLiteralElem(DoubleElemFactory _fac, DoubleElem _col , Integer _intSeed) {
			super(_fac);
			col = _col;
			intSeed = _intSeed;
		}
		...
		public String writeDesc(
			...
			if( st == null )
			{
				...
				final String colA = col == null ? "null" : col.writeDesc( (WriteElemCache<DoubleElem,DoubleElemFactory >)( cache.getInnerCache() ) , ps);
	 ...
	 *
	 */
	private static class VarElem extends SymbolicElem<DoubleElem,DoubleElemFactory>
	{
		/**
		 * The index of the component.
		 */
		 ...
		 * @param _col The index of the component.
		 */
		public VarElem(DoubleElemFactory _fac, String _col) {
			super(_fac);
			col = _col;
		}
	 ...
	 *
	 */
	private static class ConstValElem extends SymbolicElem<DoubleElem,DoubleElemFactory>
	{
		/**
		 * The index of the component.
		 */
		 ...
		 * @param _col The index of the component.
		 */
		public ConstValElem(DoubleElemFactory _fac, String _col) {
			super(_fac);
			col = _col;
		}
	 ...
	 *
	 */
	private static class ConstIntegrationElem extends SymbolicElem<DoubleElem,DoubleElemFactory>
	{
		 ...
		 * @param _col The index of the component.
		 */
		public ConstIntegrationElem(DoubleElemFactory _fac) {
			super(_fac);
		}
	 ...
	 *
	 */
	protected class TestAiOllamaParse extends AiOllamaParse<DoubleElem,DoubleElemFactory>
	{
		...
		public TestAiOllamaParse(
				SymbolicElemFactory<DoubleElem, DoubleElemFactory> _outputParseFac,
		...
		@Override
		protected SymbolicElem<DoubleElem, DoubleElemFactory> generateConstLiteral(double val) {
			DoubleElem vl = new DoubleElem( val );
			return new ConstLiteralElem( outputParseFac.getFac(), vl , null );
		}

		
		@Override
		protected SymbolicElem<DoubleElem, DoubleElemFactory> generateConstLiteral(int val) {
			DoubleElem vl = new DoubleElem( val );
			return new ConstLiteralElem( outputParseFac.getFac(), vl , new Integer(val) );
		}


		@Override
		protected SymbolicElem<DoubleElem, DoubleElemFactory> generateVar(String name) {
			return new VarElem( outputParseFac.getFac(), name );
		}


		@Override
		protected SymbolicElem<DoubleElem, DoubleElemFactory> generateIntegrationConst() {
			return new ConstIntegrationElem( outputParseFac.getFac() );
		}


		@Override
		protected SymbolicElem<DoubleElem, DoubleElemFactory> generatePi() {
			return new ConstLiteralElem( outputParseFac.getFac(), new DoubleElem( Math.PI ) , null );
		}


		@Override
		protected SymbolicElem<DoubleElem, DoubleElemFactory> generateE() {
			return new ConstLiteralElem( outputParseFac.getFac(), new DoubleElem( Math.E ) , null );
		}
		
		
		@Override
		protected SymbolicElem<DoubleElem, DoubleElemFactory> generatePow( SymbolicElem<DoubleElem, DoubleElemFactory> tva , SymbolicElem<DoubleElem, DoubleElemFactory> tvb ) throws Throwable
		{
			if( useIteratedPow )
			{
				if( tvb instanceof ConstLiteralElem )
				{
					...
					if( tvbb.getIntSeed() != null )
					{
						...
						{
							SymbolicElem<DoubleElem, DoubleElemFactory> exp = tva;
	 ...
	 *
	 */
	protected class TestAiOllamaWrite extends AiOllamaWrite<DoubleElem, DoubleElemFactory>
	{
		 ...
		 */
		public TestAiOllamaWrite(SymbolicElemFactory<DoubleElem, DoubleElemFactory> _inputParseFac) {
		...
		protected void initHndl()
		{
			...
			hndl.put( VarElem.class.getName() ,
				new SymHandler()
				{
					...
					@Override
					public AiOllamaWrite<DoubleElem, DoubleElemFactory>.PrecedenceNode hndl(
							SymbolicElem<DoubleElem, DoubleElemFactory> in) throws Throwable {
		 ...
		 */
		protected PrecedenceNode generateVar( SymbolicElem<DoubleElem, DoubleElemFactory> in ) throws Throwable
		{
		 ...
		 * @throws Throwable Throws an exception if e.g. the expression has a non-commutative operator (such as wedge product) and it's known that the current generation of Ollama AIs are not trained to process that.
		 */
		protected PrecedenceNode generateConst( SymbolicElem<DoubleElem, DoubleElemFactory> in ) throws Throwable
		{
	...
	public void testWriteAiTacPoly() throws Throwable
	{
		...
		ConstValElem constTwo = new ConstValElem( dfac, "2" );
		
		
		ConstValElem constThree = new ConstValElem( dfac, "3" );
		
		
		ConstValElem constFour = new ConstValElem( dfac, "4" );
		
		
		ConstValElem constFive = new ConstValElem( dfac, "5" );
		
		
		ConstValElem constSeven = new ConstValElem( dfac, "7" );
		
		
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> firstTerm = constFour.mult( var.powR( constThree , 10 , 10 ) );
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> secondTerm = constFive.mult( var.powR( constTwo , 10 , 10 ) );
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> thirdTerm = constSeven.mult( var );
		
		
		
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> elem = firstTerm.add( secondTerm ).add( thirdTerm );
	...
	public void testWriteAiTacXSin2X() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> sinMul = ( constTwo.mult( var ) ).sin( 10 );
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> fullTerm = var.mult( sinMul );
	...
	public void testWriteAiTacLog2X() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> lnMul = ( ( constTwo.mult( var ) ).add( sfac.identity() ) ).ln( 10 , 10 );
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> fullTerm = lnMul;
	...
	public void testWriteAiTacExpX() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> expT = var.exp( 10 );
	...
	public void testWriteAiTacCosX() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> expT = var.cos( 10 );
	...
	public void testWriteAiTacSinhX() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> expT = var.sinh( 10 );
	...
	public void testWriteAiTacCoshX() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> expT = var.cosh( 10 );
	...
	public void testWriteAiTacInvertXTimesX() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> invT = ( var.invertLeft() ).mult( var );
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> fullTerm = invT;
	...
	public void testWriteAiTacSqrtX() throws Throwable
	{
		...
		SymbolicElem<DoubleElem,DoubleElemFactory> expT = new SymbolicSqrt(var, sfac);
	...
	public void testWriteAiTacConstTimesX() throws Throwable
	{
		...
		ConstValElem val = new ConstValElem(dfac, "3.45");
		
		
		
		
		SymbolicElem<DoubleElem,DoubleElemFactory> expT = val.mult( var );
	...
	public void testWriteAiTacETimesX() throws Throwable
	{
		...
		ConstValElem val = new ConstValElem(dfac, "e");
	...
	public void testWriteAiTacPiTimesX() throws Throwable
	{
		...
		ConstValElem val = new ConstValElem(dfac, "pi");
	...
	public void testWriteAiTacCosY() throws Throwable
	{
		...
		VarElem var = new VarElem( dfac, "y" );
	 ...
	 */
	public void testParseAiTac() throws Throwable
	{
		...
		InputStream is = TestParseAiTac.class.getResourceAsStream( "ArchiveC_FinalResults.txt" );
	 ...
	 *
	 */
	protected class TestAiOllamaInteractionDerivative extends AiOllamaInteractionDerivative<DoubleElem,DoubleElemFactory,DoubleElem,DoubleElemFactory>
	{
		 ...
		 */
		public TestAiOllamaInteractionDerivative(AiOllamaWriter<DoubleElem, DoubleElemFactory> _aiOllamaWriter,
	 ...
	 *
	 */
	protected class TestAiOllamaInteractionIntegral extends AiOllamaInteractionIntegral<DoubleElem,DoubleElemFactory,DoubleElem,DoubleElemFactory>
	{
		 ...
		 * @param _aiOllamaParse Instance for parsing a Tac-like syntax from Ollama result strings into SymbolicElems
		 */
		public TestAiOllamaInteractionIntegral(AiOllamaWriter<DoubleElem, DoubleElemFactory> _aiOllamaWriter,
				AiOllamaParse<DoubleElem, DoubleElemFactory> _aiOllamaParse) {
			super(_aiOllamaWriter, _aiOllamaParse);
		}
